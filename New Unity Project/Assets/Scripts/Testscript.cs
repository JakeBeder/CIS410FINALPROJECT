...
public class Testscript : MonoBehaviour
{
    ...
    GameObject theTurret6;
    GameObject theTurret7;
    GameObject theTurret8;
    GameObject theTurret9;
    GameObject theTurret10;
    GameObject theTurret11;
    GameObject theTurret12;
    GameObject theTurret13;
    GameObject theTurret14;
    GameObject theTurret15;
    GameObject theTurret16;
    GameObject theTurret17;
    ...
    Tank_Location_Script turret6;
    Tank_Location_Script turret7;
    Tank_Location_Script turret8;
    Tank_Location_Script turret9;
    Tank_Location_Script turret10;
    Tank_Location_Script turret11;
    Tank_Location_Script turret12;
    Tank_Location_Script turret13;
    Tank_Location_Script turret14;
    Tank_Location_Script turret15;
    Tank_Location_Script turret16;
    Tank_Location_Script turret17;
...
*/
    ...
    public void Start()
    {
        ...
        theTurret6 = GameObject.Find("TurretTower_4");
        turret6 = theTurret6.GetComponent<Tank_Location_Script>();

        theTurret7 = GameObject.Find("TurretTower_5");
        turret7 = theTurret7.GetComponent<Tank_Location_Script>();

        theTurret8 = GameObject.Find("Tank_Location_3");
        turret8 = theTurret8.GetComponent<Tank_Location_Script>();

        theTurret9 = GameObject.Find("TurretTower_6");
        turret9 = theTurret9.GetComponent<Tank_Location_Script>();

        theTurret10 = GameObject.Find("TurretTower_7");
        turret10 = theTurret10.GetComponent<Tank_Location_Script>();

        theTurret11 = GameObject.Find("TurretTower_8");
        turret11 = theTurret11.GetComponent<Tank_Location_Script>();

        theTurret12 = GameObject.Find("TurretTower_9");
        turret12 = theTurret12.GetComponent<Tank_Location_Script>();

        theTurret13 = GameObject.Find("TurretTower_10");
        turret13 = theTurret13.GetComponent<Tank_Location_Script>();

        theTurret14 = GameObject.Find("TurretTower_11");
        turret14 = theTurret14.GetComponent<Tank_Location_Script>();

        theTurret15 = GameObject.Find("TurretTower_12");
        turret15 = theTurret15.GetComponent<Tank_Location_Script>();

        theTurret16 = GameObject.Find("TurretTower_13");
        turret16 = theTurret16.GetComponent<Tank_Location_Script>();

        theTurret17 = GameObject.Find("TurretTower_14");
        turret17 = theTurret17.GetComponent<Tank_Location_Script>();
    ...
    public void Shoot()
    {
        ...
        if (theEnemy != null)
        {
            enemy = theEnemy.GetComponent<EnemyHealth>();
        }
        if ((turret.isPlaced == true))
        {

            if (newenemy != null && enemy.alive == true)
            {
                float dist = 100;
                for (int i = 0; i < newenemy.Length; i++)
                {
                    if (newenemy[i] == null) continue;

                    dist = Vector3.Distance(turret.transform.position, newenemy[i].transform.position);
        ...
        if ((turret6.isPlaced == true))
        {
            ...
            if (newenemy != null && enemy.alive == true)
            {
                ...
                {
                    if (newenemy[i] == null) continue;
                    dist = Vector3.Distance(turret6.transform.position, newenemy[i].transform.position);
                    //float dist2 = Vector3.Distance(turret.transform.position, theEnemy2.transform.position);
        ...
        if ((turret7.isPlaced == true))
        {
            ...
            if (newenemy != null && enemy.alive == true)
            {
                ...
                {
                    if (newenemy[i] == null) continue;
                    dist = Vector3.Distance(turret7.transform.position, newenemy[i].transform.position);
                    //float dist2 = Vector3.Distance(turret.transform.position, theEnemy2.transform.position);
        ...
        if ((turret8.isPlaced == true))
        {
            ...
            if (newenemy != null && enemy.alive == true)
            {
                ...
                {
                    if (newenemy[i] == null) continue;
                    dist = Vector3.Distance(turret8.transform.position, newenemy[i].transform.position);
                    //float dist2 = Vector3.Distance(turret.transform.position, theEnemy2.transform.position);
        ...
        if ((turret9.isPlaced == true))
        {
            ...
            if (newenemy != null && enemy.alive == true)
            {
                ...
                {
                    if (newenemy[i] == null) continue;
                    dist = Vector3.Distance(turret9.transform.position, newenemy[i].transform.position);
                    //float dist2 = Vector3.Distance(turret.transform.position, theEnemy2.transform.position);
        ...
        if ((turret10.isPlaced == true))
        {
            ...
            if (newenemy != null && enemy.alive == true)
            {
                ...
                {
                    if (newenemy[i] == null) continue;
                    dist = Vector3.Distance(turret10.transform.position, newenemy[i].transform.position);
                    //float dist2 = Vector3.Distance(turret.transform.position, theEnemy2.transform.position);
        ...
        if ((turret11.isPlaced == true))
        {
            ...
            if (newenemy != null && enemy.alive == true)
            {
                ...
                {
                    if (newenemy[i] == null) continue;
                    dist = Vector3.Distance(turret11.transform.position, newenemy[i].transform.position);
                    //float dist2 = Vector3.Distance(turret.transform.position, theEnemy2.transform.position);
        ...
        if ((turret12.isPlaced == true))
        {
            ...
            if (newenemy != null && enemy.alive == true)
            {
                ...
                {
                    if (newenemy[i] == null) continue;
                    dist = Vector3.Distance(turret12.transform.position, newenemy[i].transform.position);
                    //float dist2 = Vector3.Distance(turret.transform.position, theEnemy2.transform.position);
        ...
        if ((turret13.isPlaced == true))
        {
            ...
            if (newenemy != null && enemy.alive == true)
            {
                ...
                {
                    if (newenemy[i] == null) continue;
                    dist = Vector3.Distance(turret13.transform.position, newenemy[i].transform.position);
                    //float dist2 = Vector3.Distance(turret.transform.position, theEnemy2.transform.position);
        ...
        if ((turret14.isPlaced == true))
        {
            ...
            if (newenemy != null && enemy.alive == true)
            {
                ...
                {
                    if (newenemy[i] == null) continue;
                    dist = Vector3.Distance(turret14.transform.position, newenemy[i].transform.position);
                    //float dist2 = Vector3.Distance(turret.transform.position, theEnemy2.transform.position);
        ...
        if ((turret15.isPlaced == true))
        {
            ...
            if (newenemy != null && enemy.alive == true)
            {
                ...
                {
                    if (newenemy[i] == null) continue;
                    dist = Vector3.Distance(turret15.transform.position, newenemy[i].transform.position);
                    //float dist2 = Vector3.Distance(turret.transform.position, theEnemy2.transform.position);
        ...
        if ((turret16.isPlaced == true))
        {
            ...
            if (newenemy != null && enemy.alive == true)
            {
                ...
                {
                    if (newenemy[i] == null) continue;
                    dist = Vector3.Distance(turret16.transform.position, newenemy[i].transform.position);
                    //float dist2 = Vector3.Distance(turret.transform.position, theEnemy2.transform.position);
        ...
        if ((turret17.isPlaced == true))
        {
            ...
            if (newenemy != null && enemy.alive == true)
            {
                ...
                {
                    if (newenemy[i] == null) continue;
                    dist = Vector3.Distance(turret17.transform.position, newenemy[i].transform.position);
                    //float dist2 = Vector3.Distance(turret.transform.position, theEnemy2.transform.position);
